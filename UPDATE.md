...
- 2025-10-06: Synced TimeMachine offset to server via cookies, removed nested <html> wrappers causing hydration errors, and stabilized planner reload behavior.
