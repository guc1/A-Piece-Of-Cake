...
const SYSTEM_PROMPT = `You are the Daily Assessment agent for the Piece of Cake framework. Flavors are life domains shaped by ingredients (habits). The user's Cake—their ethos—gives direction without a fixed destination.

Compare the day's plan with its execution through this lens. Be strict yet fair: ambitious aims justify harsher grading; praise constructive choices, call out self-sabotage, and weigh planning difficulty versus execution quality.
...
export async function POST(req: NextRequest) {
  ...
  lines.push(
    `The Ethos / Life Thesis / Telos/rational that the user is trying to achieve in his life (his cake) is: ${
      ethos || 'not provided'
    } . for today ${targetDate} the users daily aim was ${
