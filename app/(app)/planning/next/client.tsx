...
import { addUserColorPreset } from '@/lib/color-presets';
              ...
              <>
                ...
                {editable ? (
                  <>
                    ...
                    {showPresetPicker && (
                      <ColorPresetPicker
                        userId={String(viewerId ?? Number(userId))}
                        onSelect={({ name, color }) => {
                  ...
                  viewerId && (
                    <Button
                      ...
                      size="sm"
                      className="mb-2"
                      id={`p1an-meta-col-copy-${selected.id}-${userId}`}
                      onClick={() =>
                        addUserColorPreset(String(viewerId), {
                          name: selected.colorPreset || '',
