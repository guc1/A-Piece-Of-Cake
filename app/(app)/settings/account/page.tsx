        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-neutral-700">
              Freeze yesterday’s review window until noon tomorrow when you know
              you’ll finish late. Your review score still counts for yesterday.
            </p>
            {extraTime && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            ...
            <p className="mt-1 text-sm text-neutral-600">
              ...
              extending yesterday’s review window.
            </p>
            <textarea
              value={extraReason}
              ...
              placeholder="Because I finished work at 01:00 and still want to reflect on yesterday…"
            />
            {extraError && (
